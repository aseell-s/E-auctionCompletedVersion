        ...
        <div className="max-w-7xl mx-auto px-4 py-24 grid md:grid-cols-2 gap-10 items-center">
          ...
          <div className="space-y-8">
            ...
            <p className="text-lg sm:text-xl text-gray-700 leading-relaxed max-w-xl">
              Gluby is a recycling e-auction platform designed to transform
              waste into value. By connecting sellers with buyers in a
              transparent and rewarding marketplace, Gluby empowers communities
              to recycle smarter and live more sustainably.
            </p>
            ...
            <div className="relative w-full max-w-md">
              ...
              <div className="relative z-10 p-8 bg-white/80 backdrop-blur-md rounded-2xl shadow-xl border border-indigo-100 space-y-6 hover:shadow-2xl transition">
                {[
                  ...
                  <div
                    key={idx}
                    className="flex items-center space-x-4 hover:bg-indigo-100 p-2 rounded-lg transition"
                  >
                    <div
                      className={`w-14 h-14 flex items-center justify-center rounded-full text-2xl shadow-inner ${item.bg}`}
                    >
                      {item.icon}
                    </div>
                    <div>
            ...
            {[
              {
                ...
                description:
                  "List & Sell: Submit items for admin approval and start auctioning.",
                features: [
              ...
              },
              {
                ...
                description:
                  "Add balance & bid: Contact admin to fund your wallet, then start bidding.",
                features: [
              ...
              },
              {
                ...
                description:
                  "Approve listings: Review seller items before they go live.",
                features: [
              ...
              >
                ...
                <div className="p-6 space-y-4">
                  <h4 className="text-xl font-bold text-indigo-700 text-center">
                    {feature.title}
                  </h4>
        ...
        <div className="max-w-6xl mx-auto px-4 text-center">
          ...
          <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-8 text-left">
            {[
              ...
              <div
                key={i}
                className="bg-white border border-indigo-100 rounded-xl p-6 shadow-sm hover:shadow-md hover:scale-[1.02] transition-transform"
              >
      ...
      <section className="bg-gradient-to-r from-indigo-600 to-purple-600 text-white py-16">
        <div className="max-w-7xl mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-10">
            ...
            <br></br>
            For You And The Planet. Join Us Today To List. Bid. Earn. And Build
