...
//             {/* Seal/Logo */}
//             <div className="absolute top-16 right-16 opacity-20 w-28 h-28 border-4 border-gray-300 rounded-full flex items-center justify-center">
//               <span className="text-gray-500 font-bold text-sm text-center">
//                 E-AUCTION SEAL
//               </span>
//             </div> */}
